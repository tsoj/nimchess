# Shared UCI engine integration tests.
# Include this from a test file that defines:
#   const testEngine {.strdefine.}: string
# These tests work with any UCI-compliant engine.
